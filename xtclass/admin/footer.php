...
<?php if (is_writable(xtclass_images_uploads_path())) : ?>
    ...
    <h2 class="render-title"><?php _e('Footer logo', XTCLASS_THEME_FOLDER); ?></h2>
    ...
    <?php if ($logo) : ?>
        ...
        <form action="<?php echo osc_admin_render_theme_url('oc-content/themes/'.XTCLASS_THEME_FOLDER.'/admin/footer.php');?>" method="post" enctype="multipart/form-data" class="nocsrf">
